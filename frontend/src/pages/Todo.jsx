...
function Todo() {
    ...
    return (
        <>
            <div>
                <Button sx={{ backgroundColor: 'grey', float: 'right', margin: '1% 5%' }} variant="contained" onClick={handleOpen}>Add Task</Button>
                <Modal
                    open={open}
                    onClose={handleClose}
                                            ...
                                            taskList.map((t, index) =>
                                                <TableRow className={t.completed ? 'done':''} id ={`task_row${index}`} key={`task_row${index}`} style={index % 2 === 0 ? evenRow : oddRow}>
                                                    ...
                                                    <TableCell style={{width:'fit-content',textAlign:'center'}} >
                                                        <Button onClick={editTask} sx={{ backgroundColor: '#ad8b10',  fontSize:'1rem' ,margin:'.1rem .1rem' }} variant="contained"><i className="bi bi-pencil-square"></i></Button>
                                                        <Button onClick={deleteTask} sx={{ backgroundColor: '#881818',  fontSize:'1rem' ,margin:'.1rem .1rem' }} variant="contained"><i className="bi bi-trash3"></i></Button>
